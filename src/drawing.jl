...
function draw_circle!(image::AbstractMatrix, center_i::Integer, center_j::Integer, radius::Integer, value)
...
function draw_line!(image::AbstractMatrix, i0::Int, j0::Int, i1::Int, j1::Int, value)
    di = abs(i1 - i0)
    dj = -abs(j1 - j0)
    si = i0 < i1 ? 1 : -1
    sj = j0 < j1 ? 1 : -1
